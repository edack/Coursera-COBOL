      ...
      *-------------
       ...
       01  PRINT-REC.
           ...
           05  FILLER         PIC X(02) VALUE SPACES.
           05  ACCT-BALANCE-FICA-O PIC $$,$$$,$$9.99.
           05  FILLER         PIC X(02) VALUE SPACES.
      *
       ...
       01  ACCT-FIELDS.
           ...
           05  CLIENT-ADDR.
               ...
               10  USA-STATE      PIC X(15).
                    88  OHIO             VALUE 'Ohio'.
                    88  NEW-YORK         VALUE 'New York'.
                    88  VIRGINIA         VALUE 'Virginia'.
           05  RESERVED           PIC X(7).
      ...
      *
       01  TLIMIT-TBALANCE.
           ...
           05 FICA                PIC S9V99    COMP   VALUE ZERO.
           05 HOLD-ACCT-BALANCE   PIC S9(7)V99 COMP   VALUE ZERO.
      *
       01  HEADER-1.
      ...
      *
       LIMIT-BALANCE-TOTAL.
           ...
           EVALUATE TRUE
                WHEN Virginia   MOVE .09 TO FICA
                WHEN NEW-YORK   MOVE .13 TO FICA
                WHEN OHIO       MOVE .11 TO FICA
                WHEN OTHER      MOVE   0 TO FICA
           END-EVALUATE
           COMPUTE HOLD-ACCT-BALANCE = ACCT-BALANCE -
                 (ACCT-BALANCE * FICA) END-COMPUTE
           .
      *
       WRITE-RECORD.
           ...
           MOVE HOLD-ACCT-BALANCE TO ACCT-BALANCE-FICA-O
           WRITE PRINT-REC.
      *
